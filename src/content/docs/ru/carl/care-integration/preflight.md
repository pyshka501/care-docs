...
| `missing_tools` | Инструменты, на которые есть ссылки, но которые **не** зарегистрированы в контексте (список CARE «зарегистрировать перед запуском»). |
...
Отчёт **структурирован, а не нарративен** — CARE превращает его в модальное окно; CLI и
