---
title: Быстрый старт
description: Запустите CARE TUI и сгенерируйте первую цепочку агента за пять минут.
sidebar:
  order: 1
---
...
CARE открывается сразу в **чат-поверхности** — транскрипт в стиле Claude Code с
полем ввода снизу и переключателем режима над ним.
...
MAGE сгенерирует цепочку, CARL тут же её выполнит, и ответ выведется инлайн.
При первом запуске появится предложение ввести `/tour` — 5-шаговый тур.
