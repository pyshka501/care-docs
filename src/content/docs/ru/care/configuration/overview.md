---
title: Конфигурация
description: Как MAESTRO CARE читает конфигурацию — четыре слоя и маппинг TOML ↔ env.
sidebar:
  order: 1
---

MAESTRO CARE читает конфигурацию из четырёх слоёв в порядке возрастания приоритета:
