---
title: Обзор
description: Agent Skill care-cli — даёт Claude Code или hermes управлять MAESTRO CLI с переносимым автоопределением `care`.
sidebar:
  order: 1
---
...
интерпретировать** их, диагностировать окружение — без жёсткой привязки к пути до MAESTRO.
...
- **Autodebug** — в бандле лежит **карта репозиториев** всего стека MAESTRO/CARL (что за
