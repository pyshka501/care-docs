---
title: Примеры
description: Встроенные примеры цепочек и сквозной рабочий процесс MAESTRO CARE.
sidebar:
  order: 1
---

MAESTRO CARE поставляется с несколькими готовыми цепочками, которые можно валидировать, импортировать и запускать.
...
Канонический цикл MAESTRO CARE от начала до конца:

1. **Генерация** — введите задачу в [чат-поверхности](/ru/care/tui/overview/) (или `care generate "<task>"`).
