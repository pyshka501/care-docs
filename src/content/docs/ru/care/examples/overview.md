---
title: Примеры
description: Встроенные примеры цепочек и сквозной рабочий процесс CARE.
sidebar:
  order: 1
---

CARE поставляется с несколькими готовыми цепочками, которые можно валидировать, импортировать и запускать.
...
Канонический цикл CARE от начала до конца:
