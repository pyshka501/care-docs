...
> Memory — overview + COW + LTM + schema; Async — execution + streaming; RE-PLAN — overview + checkers/aggregation; Evaluation — metrics + datasets + reflection; Evolution — evolver + mutation/results.
...
>  §3.11 Tracing/Cost, §3.12 LLM-clients, §3.13 Orchestration, §3.14 Skills, §3.15 MCP,
